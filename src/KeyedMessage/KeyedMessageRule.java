 ...
 */
public class KeyedMessageRule implements Serializable{
    public String regex = "";
    ...
    transient Map<String, String> idTokenMap;
    transient Map<String, String> valueTokenMap;
    ...
    public void buildRule(LCSObject lcsObject) {
        ...
        buildRule(LCSseq, POSseq, null);
    }

    public void buildRule(String[] LCSseq, String[] POSseq, List<String> entityList) {
...
//                }
        ...
        regex = regex.trim();
        assignKey(entityList);
    }

    //TODO: assign keys to each log message
    private void assignKey(List<String> entityList) {
