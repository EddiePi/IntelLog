...
//        }
    ...
    public void lemmatize() throws Exception {
        String[] words = new String[]{"Most", "large", "cities", "in", "the", "US", "had",
                "morning", "and", "afternoon", "newspapers"};
        String[] tags = {"JJS", "JJ", "NNS", "IN", "DT", "NNP", "VBD",
                "NN", "CC", "NN", "NNS"};
        String[] lemmatized = lemmatizer.lemmatize(words, tags);
        System.out.println(Arrays.toString(lemmatized));
